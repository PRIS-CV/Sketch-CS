...
class BaseOptions:
    ...
    def initialize(self):
        # data params
        self.parser.add_argument('--class-name', type=str, default='Creative_Creature', 
        ...
        # networks
        self.parser.add_argument('--creativity-alpha', type=float, default=0.8)
        self.parser.add_argument('--creativity-beta', type=float, default=1000)
        self.parser.add_argument('--iteration-num', type=float, default=1)
        self.parser.add_argument('--net-name', type=str, default='SketchGNN_CreativitySeg', 
        ...
        self.parser.add_argument('--dilation', type=int, default=16,
                                 help='')
        self.parser.add_argument('--stochastic', action='store_true', default=True,
                                 help='')
...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--pi-weight-decay', type=float, default=1e-3)
